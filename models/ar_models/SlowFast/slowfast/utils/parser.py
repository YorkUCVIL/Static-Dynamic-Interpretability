...
def parse_args():
    ...
    parser.add_argument('--cust_nsf_nf_sr', default=[8,8,1], type=list, help="number of frames to sample from video during training")
    parser.add_argument('--kin_subset', default='temporal', help="Subset for stylized kin (temporal | static | random [none])")
    parser.add_argument('--joint_encoding', default=False, help="Present figure of motion-appearance joint encoding neurons")
    parser.add_argument('--joint_encoding_thresh', default=0.25, help="Thrershold of motion-appearance joint encoding neurons")
    parser.add_argument('--kin_subset_pretrain', default='random', help="Network pretrained subset for stylized kin (temporal | static | random [none])")
