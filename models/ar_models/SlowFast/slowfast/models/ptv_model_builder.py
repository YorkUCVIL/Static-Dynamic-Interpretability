...
from models.ar_models.SlowFast.slowfast.models.batchnorm_helper import get_norm
from models.ar_models.SlowFast.slowfast.models.video_model_builder import _POOL1, _TEMPORAL_KERNEL_BASIS

from models.ar_models.pytorchvideo.pytorchvideo.models.csn import create_csn
from models.ar_models.pytorchvideo.pytorchvideo.models.r2plus1d import (
    create_2plus1d_bottleneck_block,
    create_r2plus1d,
)
from models.ar_models.pytorchvideo.pytorchvideo.models.resnet import create_bottleneck_block, create_resnet
from models.ar_models.pytorchvideo.pytorchvideo.models.slowfast import create_slowfast
from models.ar_models.pytorchvideo.pytorchvideo.models.x3d import (
    Swish,
    create_x3d,
...
class PTVResNet(nn.Module):
    ...
    def forward(self, x, stage=None, bboxes=None):
        x = x[0]
        x = self.model(x, stage=stage)
...
class PTVSlowFast(nn.Module):
    ...
    def forward(self, x, path=None, stage=None, fuse=None, bboxes=None):
        x = self.model(x, path=path, stage=stage, fuse=fuse)
        # Performs fully convlutional inference.
        # if not self.training:
        #     x = self.post_act(x)
        #     x = x.mean([2, 3, 4])
