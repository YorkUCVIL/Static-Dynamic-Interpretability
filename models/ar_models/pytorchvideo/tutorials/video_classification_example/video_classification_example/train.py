...
"""
This video classification example demonstrates how PyTorchVideo models, dataset_factory and
transforms_old can be used with PyTorch Lightning module. Specifically it shows how a
...
class VideoClassificationLightningModule(pytorch_lightning.LightningModule):
    ...
    def on_train_epoch_start(self):
        """
        For distributed training we need to set the dataset_factory video sampler epoch so
    ...
    def training_step(self, batch, batch_idx):
        ...
        The PyTorchVideo models and transforms_old expect the same input shapes and
...
class KineticsDataModule(pytorch_lightning.LightningDataModule):
    ...
    preprocessing transforms_old and configures the PyTorch DataLoaders.
    """
    ...
    def _make_transforms(self, mode: str):
        ...
        #
        # In the case that the recommended libraries don't provide transforms_old that
    ...
    def _video_transform(self, mode: str):
        """
        This function contains example transforms_old using both PyTorchVideo and TorchVision
    ...
    def _audio_transform(self):
        """
        This function contains example transforms_old using both PyTorchVideo and TorchAudio
