...
class Interactive(nn.Module):
    ...
    def spatial_decoder(self, x, spatial_f, temporal_f, stages=None, interm_out={}):
        ...
        fused3 = self.Transformerstafm3(spatial_f[2], temporal_f[2])
        interm_out.update(
        ...
        fused2 = self.Transformerstafm2(spatial_f[1], temporal_f[1])
        interm_out.update(
        ...
        fused1 = self.Transformerstafm1(spatial_f[0], temporal_f[0])
        interm_out.update(
    ...
    def encoder(self, x, flow, stages=None):
        ...
        interm_out.update(
            set_stage_stream("conv1", requested_stages, requested_streams, spatial0, temporal0, None)
        )
        ...
        return spatial5, [h1_spatial, h2_spatial, h3_spatial], temporal5, [h1_temporal, h2_temporal, h3_temporal], interm_out
    ...
    def forward(self, img, stages=None):
        ...
        return self.spatial_decoder(spatial, spatial_feature, temporal_feature,
                                    stages=stages, interm_out=interm_out)
